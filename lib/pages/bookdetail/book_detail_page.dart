...
class _BookDetailPageState extends State<BookDetailPage> {
  ...
  setupCatalogue() async {
    List <BookCatalogue> catalogueList = await BookReptile.getBookCatalogueWithBookInfo(Provider.of<BookDetailModel>(context,listen: false).openBookInfo);
    Provider.of<BookDetailModel>(context,listen: false).setupCatalogue(catalogueList);
        ...
        children: [
          Container(
            ...
            child: ExtendedImage.network(
              Provider.of<BookDetailModel>(context,listen: false).openBookInfo.imgUrl,
              cache: true,
              fit: BoxFit.cover,
              height: ScreenTools.getSize(840),
              width: double.infinity,
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                        child: Container(
                          margin: EdgeInsets.only(left: ScreenTools.getSize(
                              42)),
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                Provider.of<BookDetailModel>(context,listen: false).openBookInfo.title,
                                style: TextStyle(
  ...
  Widget _bookDetailTextWidget() {
    return Container(
      ...
      child: Text(
        Provider.of<BookDetailModel>(context,listen: false).openBookInfo.detail,
        softWrap: true,
        maxLines: 999,
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(isLoading?"正在加载":"共${Provider.of<BookDetailModel>(context,listen: false).openBookCatalogue.length}章", style: TextStyle(
                fontSize: ScreenTools.getSize(45),
    ...
    return Scaffold(
      body: SafeArea(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [_bookDetailWidget(), _bookDetailTextWidget(),_bookCatalogueWidget()],
            ),
          )),
    );
  }
